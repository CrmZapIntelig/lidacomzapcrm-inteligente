...
export default function Sidebar({
  ...
  const menuItems = [
    ...
    { id: 'entregas', label: 'Entregas', icon: Bike, color: 'text-sky-500' },
    { id: 'entregadores', label: 'Entregadores', icon: UserCheck, color: 'text-emerald-400' },
    { id: 'rotas', label: 'Rotas', icon: Map, color: 'text-sky-450' },
    { id: 'rastreamento', label: 'Rastreamento', icon: Navigation, color: 'text-indigo-400' },
